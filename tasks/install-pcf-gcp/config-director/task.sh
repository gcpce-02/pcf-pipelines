...
[{
  ...
  "networks": {
    ...
    "network_collection[networks_attributes][0][subnets][0][dns]": "8.8.8.8,8.8.4.4",
    ...
    "network_collection[networks_attributes][1][subnets][0][dns]": "8.8.8.8,8.8.4.4",
    ...
    "network_collection[networks_attributes][2][subnets][0][dns]": "8.8.8.8,8.8.4.4",
