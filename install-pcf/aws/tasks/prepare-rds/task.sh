...
CREATE DATABASE IF NOT EXISTS locketdb;
CREATE USER IF NOT EXISTS '$DB_LOCKET_USERNAME' IDENTIFIED BY '$DB_LOCKET_PASSWORD';
GRANT ALL ON locketdb.* TO '$DB_LOCKET_USERNAME'@'%';

CREATE DATABASE IF NOT EXISTS silkdb;
CREATE USER IF NOT EXISTS '$DB_SILK_USERNAME' IDENTIFIED BY '$DB_SILK_PASSWORD';
GRANT ALL ON silkdb.* TO '$DB_SILK_USERNAME'@'%';
