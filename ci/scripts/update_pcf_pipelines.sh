...
# params_lre1_aws_ert_upgrade=$(lpass show Shared-Customer\ [0]/lre1-aws/ert-upgrade-params --notes)
# params_lre1_aws_buildpacks_upgrade=$(lpass show Shared-Customer\ [0]/lre1-aws/buildpacks-upgrade-params --notes)
